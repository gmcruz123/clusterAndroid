...
import unicauca.movil.midestin.databinding.ActivityDetailReservaBinding;
...
public class DetailActivityReserva  extends AppCompatActivity implements  ViewTreeObserver.OnGlobalLayoutListener {
    ...
    ActivityDetailReservaBinding binding;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_detail_reserva);
